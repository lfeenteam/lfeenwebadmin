...
export class HeaderComponent {
  ...
  changeLanguage(lang: any): void {
    ...
    if (lang.code === 'ar') {
      this.settings.setOptions({ language: lang.code, dir: 'rtl' }, true); // true = manual change
      this.options.dir = 'rtl';
    } else {
      this.settings.setOptions({ language: lang.code, dir: 'ltr' }, true); // true = manual change
